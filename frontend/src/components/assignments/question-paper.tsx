...
export function QuestionPaperView({ paper, lockedQuestionIds, onToggleLock }: QuestionPaperViewProps) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-3xl mx-auto">
      <article className="w-full rounded-2xl bg-surface px-5 py-8 text-[14px] leading-7 text-ink sm:px-10 sm:py-10 print:px-0 print:py-0 print:shadow-none">
        {/* Header */}
      ...
      {paper.answerKey.length > 0 && (
        <article className="w-full rounded-2xl bg-surface px-5 py-8 text-[14px] leading-7 text-ink sm:px-10 sm:py-10 break-before-page print:px-0 print:py-0 print:shadow-none">
          <h2 className="text-[18px] font-bold text-center mb-6">Answer Key</h2>
